...
$query = "SELECT equipment_id,count(equipment_id) as total from booking where booking_type = 1 group by equipment_id order by total desc limit 1";
...
$query2 = "Select count(booking_id) as total from booking where booking_type = 1";
